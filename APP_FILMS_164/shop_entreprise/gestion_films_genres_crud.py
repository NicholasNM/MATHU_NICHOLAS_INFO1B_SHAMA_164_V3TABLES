"""
    ...
    Gestions des "routes" FLASK et des données pour l'association entre les shops et les genres.
"""
...
"""
    ...
    But : Afficher les shops avec les genres associés pour chaque film.
    
    Paramètres : id_genre_sel = 0 >> tous les shops.
...
def films_genres_afficher(id_film_sel):
        ...
        try:
            with DBconnection() as mc_afficher:
                strsql_genres_films_afficher_data = """SELECT id_film, nom_film, duree_film, description_film, cover_link_film, date_sortie_film,
                                                            ...
                                                            GROUP BY id_film"""
                if id_film_sel == 0:
                    # le paramètre 0 permet d'afficher tous les shops
                ...
                if not data_genres_films_afficher and id_film_sel == 0:
                    ...
                    flash(f"Données shops et genres affichés !!", "success")
    ...
    return render_template("shop_entreprise/films_genres_afficher.html", data=data_genres_films_afficher)
...
def edit_genre_film_selected():
    ...
    return render_template("shop_entreprise/films_genres_modifier_tags_dropbox.html",
...
def update_genre_film_selected():
    ...
    # on affiche les shops et le(urs) genre(s) associé(s).

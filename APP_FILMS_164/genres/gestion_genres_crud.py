        ...
        try:
            with DBconnection() as mc_afficher:
                if order_by == "ASC" and id_genre_sel == 0:
                    strsql_genres_afficher = """SELECT id_personnes, nom_personnes, datenaissance FROM t_personnes ORDER BY id_personnes ASC"""
                    ...
                    strsql_genres_afficher = """SELECT id_personnes, nom_personnes, datenaissance FROM t_personnes WHERE id_personnes = %(value_id_genre_selected)s"""

                    mc_afficher.execute(strsql_genres_afficher, valeur_id_genre_selected_dictionnaire)
                else:
                    strsql_genres_afficher = """SELECT id_personnes, nom_personnes, datenaissance FROM t_personnes ORDER BY id_personnes  DESC"""
...
def genre_update_wtf():
    ...
    try:
        ...
        if form_update.validate_on_submit():
            ...
            str_sql_id_genre = "SELECT id_personnes, nom_personnes, datenaissance FROM t_personnes " \
    ...
    try:
        ...
        if request.method == "GET":
            ...
            with DBconnection() as mydb_conn:
                ...
                # Opération sur la BD pour récupérer "id_genre" et "intitule_genre" de la "t_genre"
                str_sql_id_genre = "SELECT id_personnes, nom_personnes, datenaissance FROM t_personnes = %(value_id_genre)s"

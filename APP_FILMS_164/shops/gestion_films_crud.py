"""Gestion des "routes" FLASK et des données pour les shops.
...
from APP_FILMS_164.shops.gestion_films_wtf_forms import FormWTFUpdateFilm, FormWTFAddFilm, FormWTFDeleteFilm
...
Remarque :  Dans le champ "nom_film_update_wtf" du formulaire "shops/films_update_wtf.html",
...
def film_add_wtf():
    ...
    if request.method == "POST":
        try:
            if form_add_film.validate_on_submit():
                ...
                # Pour afficher et constater l'insertion du nouveau film (id_film_sel=0 => afficher tous les shops)
    ...
    return render_template("shops/film_add_wtf.html", form_add_film=form_add_film)
...
def film_update_wtf():
    ...
    return render_template("shops/film_update_wtf.html", form_update_film=form_update_film)
...
Remarque :  Dans le champ "nom_film_delete_wtf" du formulaire "shops/film_delete_wtf.html"
...
def film_delete_wtf():
    ...
    try:
        # Si on clique sur "ANNULER", afficher tous les shops.
        if form_delete_film.submit_btn_annuler.data:
            return redirect(url_for("films_genres_afficher", id_film_sel=0))

        if form_delete_film.submit_btn_conf_del_film.data:
            # Récupère les données afin d'afficher à nouveau
            # le formulaire "shops/film_delete_wtf.html" lorsque le bouton "Etes-vous sur d'effacer ?" est cliqué.
    ...
    return render_template("shops/film_delete_wtf.html",

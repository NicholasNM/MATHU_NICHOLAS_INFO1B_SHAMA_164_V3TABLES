...
DROP DATABASE IF EXISTS MATHU_NICHOLAS_INFO1B_SHAMA_164_2022;

-- Création d'un nouvelle base de donnée

CREATE DATABASE IF NOT EXISTS MATHU_NICHOLAS_INFO1B_SHAMA_164_2022;

-- Utilisation de cette base de donnée

USE MATHU_NICHOLAS_INFO1B_SHAMA_164_2022;
-- --------------------------------------------------------
--
...
INSERT INTO `t_personnes` (`id_personnes`, `nom_personne`, `prenom_personne`, `num_personne`, `email_personne`, `date_naissance`) VALUES

...
(19, 'Un élève en contact avec du MySql hésite entre la perfetion et la découverte', 695, 'Le petit Simon INFO 1B (prénom d\'emprunt) est fier de commencer son apprentissage d\'informaticien dans une grande entreprise de l\'ouest Lausannois. Petit, il savait déjà changer en turc la langue par défaut du gsm de sa grand-mère. La réalité de l\'école professionnelle va le projeter dans l\'horreur du MySql, lui qui rêvait de faire des graphismes en 3D aux couleurs d\'avatar. Il doit se soustraire à stocker des caractères de texte dans una base de donnée. Le film raconte avec force et un faible budget, l\'évolution du petit Simon vers un monde meilleur que celui du stockage des caractères. Mahleureusement Simon cache un lourd secret en relation avec ses fréquentations (sur le dark-web) des groupes de dessins au crayon gris HB.', 'https://www.cine-feuilles.ch/storage/app/uploads/public/5a3/e8c/81c/thumb_25061_360_480_0_0_auto.jpg', '2020-09-16');
...
(141, 14, 3, '2020-02-12 19:30:33'),
(144, 4, 5, '2020-02-12 19:35:59'),
(145, 1, 14, '2020-02-12 19:36:57'),
(146, 16, 3, '2020-02-12 19:38:01'),
(147, 1, 12, '2020-02-12 19:39:32'),
(148, 1, 17, '2020-02-12 19:40:44'),
(149, 4, 17, '2020-02-12 19:41:00'),
(150, 2, 17, '2020-02-12 19:44:15'),
(151, 12, 15, '2020-02-12 19:46:21'),
(152, 1, 15, '2020-02-12 19:46:21'),
(153, 1, 13, '2020-02-12 19:54:31'),
(154, 4, 13, '2020-02-12 19:54:31'),
(155, 9, 12, '2020-02-12 19:55:36'),
(156, 13, 19, '2020-02-12 19:57:03'),
(157, 6, 19, '2020-02-12 19:58:03'),
(158, 5, 3, '2021-05-01 07:30:39'),
(159, 6, 3, '2021-05-01 07:30:39'),
(160, 8, 3, '2021-05-01 07:30:39'),
(161, 9, 3, '2021-05-01 07:30:39'),
(162, 10, 3, '2021-05-01 07:30:39'),
(163, 17, 3, '2021-05-01 07:30:39'),
(164, 2, 3, '2021-05-02 11:10:04'),
(165, 3, 3, '2021-05-02 11:10:04'),
(166, 4, 3, '2021-05-02 11:10:04'),
(167, 16, 5, '2021-05-02 14:06:17'),
(168, 3, 5, '2021-05-02 14:06:17'),
(172, 13, 18, '2021-05-02 14:38:10'),
(173, 4, 18, '2021-05-02 14:45:45'),
(179, 2, 11, '2021-05-02 16:39:16'),
(180, 8, 4, '2021-05-02 16:43:35'),
(183, 16, 4, '2021-05-02 16:43:43');
